...
*  @date 2025-04-23
*  @functions
*  1.API gateway, manage all access to different network
...
const mock={
    world:(ck)=>{
        return {
            name:"Septopus World",                    //VBW的名称
            desc:"Vultral Block World on chain.",   //世界的描述
    ...
    block:(x,y,world,ck)=>{
        return {
            ...
            data:[
                ...
                1,          //block的状态
                [
                    ["a1",[[[1.5,0.2,3],[2,6,0],[0,0,0],Toolbox.rand(60,90),[1,1],1,[],2025]]],
                    ["a2",[[[1.2,1.2,1.2],[8,8,2],[0,0,0],Toolbox.rand(100,300),[1,1],0,2025]]],
                    ["a4",[[[3,4,3],[8,12,0.5],[0,0,0],Toolbox.rand(1,30),0,2025]]]
                ]
            ],        //链上的block数据
...
const API={
    ...
    view:(x,y,ext,world,ck)=>{
        const arr=self.getExtBlocks(x,y,ext,[4096,4096]);
        //console.log(arr);
